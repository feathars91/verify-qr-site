...
export class Tbl3 extends Component {
  ...
  changevis() {
    this.props.passDataToParent("display");
  }
...
var tt;
    editor = new $.fn.dataTable.Editor({
      ...
      fields: [
        ...
        { label: "Date of Birth:", name: "last_name" },
        { label: "Zip Code:", name: "zip" },
        {
          ...
          display: function (file_id) {
            ...
            try {
              $("#in2").text("Link to S3 location");
              $("#in").text("https://datatables-editor.s3.us-east-2.amazonaws.com/" + editor.file("files", file_id).filename);
              return (
  ...
  render() {
    return (
      ...
      >
        <button id="btnhidden" onClick={this.changevis} />
        <h1 id="in2"></h1>
      <h1 id="in"></h1>
        <dl>
          <dt></dt>
